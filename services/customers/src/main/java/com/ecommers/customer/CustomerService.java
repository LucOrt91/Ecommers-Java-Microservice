...
import com.ecommers.exception.CustomerNotFoundException;
...
public class CustomerService {
    ...
    public CustomerResponse findById(String customerId) {
        return repository.findById(customerId)
                .map(mapper::fromCustomer)
                .orElseThrow(() -> new CustomerNotFoundException(format("Not customer found with the provider ID:: %s ", customerId)));
    }
